...
export const metadata: Metadata = {
  title: 'Paintless Dent Removal in Danville, CA - Diablo Dents',
  description: 'Expert paintless dent removal service in Danville, CA. Door dings, hail damage, and all types of dent repair. Mobile service comes to you in Danville.',
  keywords: 'paintless dent removal Danville, PDR Danville CA, dent repair Danville',
};
    ...
    <main>
      ...
      <section className="py-20 md:py-32 bg-dark-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="section-title mb-6 text-4xl md:text-5xl">
            Paintless Dent Removal in Danville, CA
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl">
            Expert paintless dent removal service right here in Danville. We come to you for convenient, quality repair without the hassle of drop-offs or waiting in body shops.
          </p>
        </div>
      </section>

      {/* Why Danville Residents Trust Diablo Dents */}
      <section className="py-20 md:py-28 bg-dark-accent border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-title text-3xl md:text-4xl mb-12 text-center">
            Why Danville Chooses Diablo Dents
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              <CheckIcon />
              <div>
                <h3 className="text-xl font-bold mb-2">Mobile Service in Danville</h3>
                <p className="text-gray-300">Chris brings his expertise to your home or office in Danville. No appointment hassle or drop-offs required.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <CheckIcon />
              <div>
                ...
                <p className="text-gray-300">Chris has been serving Danville and the Tri-Valley since 2003 with expert paintless dent removal service.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <CheckIcon />
              <div>
                ...
                <p className="text-gray-300">Most dents are repaired in a single visit. Get back on Danville's roads quickly with your vehicle looking like new.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <CheckIcon />
              <div>
                ...
                <p className="text-gray-300">Paintless repair maintains your Danville vehicle's original factory finish, protecting its resale value better than traditional methods.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <CheckIcon />
              <div>
                ...
                <p className="text-gray-300">89 five-star Google reviews and counting. Danville trusts our quality and professionalism.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <CheckIcon />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card">
              ...
              <p className="text-gray-300">Small dents from parked car impacts throughout Danville neighborhoods are our specialty.</p>
            </div>
            <div className="card">
              <h3 className="text-xl font-bold mb-3 text-teal">Hail Damage</h3>
              <p className="text-gray-300">Multiple dents from hail storms fully restored without repainting in Danville.</p>
            </div>
            <div className="card">
              <h3 className="text-xl font-bold mb-3 text-teal">Creases & Dents</h3>
              <p className="text-gray-300">Minor creases and everyday dents expertly repaired in Danville.</p>
            </div>
            <div className="card">
            ...
            <div className="card">
              ...
              <p className="text-gray-300">Roof damage expertly removed without affecting your Danville vehicle's interior.</p>
            </div>
            <div className="card">
      ...
      <section className="py-20 md:py-28 bg-dark-accent border-t border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass rounded-xl p-8 md:p-12">
            <h2 className="text-3xl font-bold mb-6">We Come to You in Danville</h2>
            <p className="text-lg text-gray-300 mb-8">
              Serving Danville and the surrounding Tri-Valley area, Chris brings his specialized equipment directly to your location for convenient, professional paintless dent removal service. No need to drive across town to a body shop.
            </p>
            <div className="bg-dark-bg/50 rounded-lg p-6 border border-white/10 mb-8">
              ...
              <p className="text-gray-400 text-sm mt-2">Schedule your Danville dent removal appointment today</p>
            </div>
      ...
      <section className="py-20 md:py-28 bg-dark-bg">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="section-title mb-6">Get Your Danville Dents Fixed Today</h2>
